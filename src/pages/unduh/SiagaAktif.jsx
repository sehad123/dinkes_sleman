    ...
    >
      ...
      <div className="flex items-center justify-center w-max container">
        <div className="lg:w-[700px] w-[380px]">
          <h4 className="font-bold text-[19px] my-5 text-center ">Bahan Pengembangan Desa Siaga Aktif</h4>
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-400 px-4 py-2">
                  <a className="" href="#">
                    Standar Operational Procedure Pemberdayaan Masyarakat
                  </a>
                </td>
                <td className="border border-gray-400 px-4 py-2">
              ...
              <tr>
                ...
                <td className="border border-gray-400 px-4 py-2">
                  <a className="" href="#">
                    Pedoman Umum Pengembangan Desa/Kelurahan Siaga Aktif
                  </a>
                </td>
                <td className="border border-gray-400 px-4 py-2">
                  <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Lihat</button>
              ...
              <tr>
                ...
                <td className="border border-gray-400 px-4 py-2">
                  <a className="" href="#">
                    Surat Edaran Menteri Dalam Negeri Republik Indonesia Nomor : 140/1508/SJ tentang Pedoman Pokjanal Desa Siaga Aktif
                  </a>
                </td>
                <td className="border border-gray-400 px-4 py-2">
                  <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Lihat</button>
              ...
              <tr>
                ...
                <td className="border border-gray-400 px-4 py-2">
                  <a className="" href="#">
                    Buku Petunjuk Teknis Biaya Pengembangan Desa Siaga Aktif
                  </a>
                </td>
                <td className="border border-gray-400 px-4 py-2">
                  <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Lihat</button>
              ...
              <tr>
                ...
                <td className="border border-gray-400 px-4 py-2">
                  <a className="" href="#">
                    Perbup Sleman Nomor 6 Tahun 2015 tentang Alokasi Dana Desa
                  </a>
                </td>
                <td className="border border-gray-400 px-4 py-2">
                  <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Lihat</button>
              ...
              <tr>
                ...
                <td className="border border-gray-400 px-4 py-2">
                  <a className="" href="#">
                    Perbup Sleman Nomor 9 Tahun 2015 tentang Anggaran Pendapatan Belanja Desa
                  </a>
                </td>
                <td className="border border-gray-400 px-4 py-2">
                  <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Lihat</button>
              ...
              <tr>
                ...
                <td className="border border-gray-400 px-4 py-2">
                  <a className="" href="#">
                    Perbup Sleman Nomor 16.1 Tahun 2020 tentang Perubahan Atas Perbup Nomor 1.2 tahun 2020 tentang Tata Cara Pembagian dan Penetapan Rincian Dana Desa
                  </a>
                </td>
                <td className="border border-gray-400 px-4 py-2">
                  <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Lihat</button>
              ...
              <tr>
                ...
                <td className="border border-gray-400 px-4 py-2">
                  <a className="" href="#">
                    Video Best Practice Desa Siaga Aktif
                  </a>
                </td>
                <td className="border border-gray-400 px-4 py-2">
                  <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Lihat</button>
              ...
              <tr>
                ...
                <td className="border border-gray-400 px-4 py-2">
                  <a className="" href="#">
                    Materi Penguatan Kelembagaan Kader DESI PAMAN klik disini
                  </a>
                </td>
                <td className="border border-gray-400 px-4 py-2">
                  <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Lihat</button>
