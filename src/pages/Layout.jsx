  ...
  return (
    <>
      ...
      <div className="relative flex flex-col lg:items-start items-center md:flex-row">
        ...
        {isProfilPage && (
          <div className={`w-[10px] absolute top-[30px] ${!isSidebarOpen ? "left-0 mt-[100px]" : "lg:left-[290px] top-[460px] left-[390px]"} transition-all duration-300`}>
        ...
        {isUnduhPage && (
          <div className={`w-[10px] absolute top-[30px] ${!isSidebarUnduhOpen ? "left-0 mt-[100px]" : "lg:left-[290px] top-[480px] left-[390px]"} transition-all duration-300`}>
        ...
        {isInfoPage && (
          <div className={`w-[10px] absolute top-[30px] ${!isSidebarInfoOpen ? "left-0 mt-[100px]" : "lg:left-[290px] top-[500px] left-[440px]"} transition-all duration-300`}>
        ...
        {isMediaPage && (
          <div className={`w-[10px] absolute top-[30px] ${!isSidebarMediaOpen ? "left-0 mt-[100px]" : "lg:left-[290px] top-[450px] left-[410px]"} transition-all duration-300`}>
