...
const Batang = () => {
  ...
  return (
    <div
      className="my-10 lg:h-[500px] h-[500px] lg:w-[850px] w-screen  border lg:rounded-3xl lg:m-10 bg-white dark:bg-gray-900 dark:text-white duration-200 overflow-y-auto  drop-shadow-[-5px_5px_8px_rgba(0,0,0,0.3)]"
