...
const Spm = () => {
  return (
    <div
      className="lg:translate-x-0 translate-x-20 my-10 lg:h-[500px] lg:w-[850px] w-[480px]  border lg:rounded-3xl lg:m-10 bg-white dark:bg-gray-900 dark:text-white duration-200 h-[430px] overflow-y-auto  drop-shadow-[-5px_5px_8px_rgba(0,0,0,0.3)]"
      style={{ fontFamily: "Montserrat, sans-serif" }}
    >
      {" "}
      <div className="flex items-center justify-center w-max container">
        <div className="lg:w-[600px] w-[380px]">
          <h4 className="font-bold text-[19px] my-5 text-center">Standar Pelayanan Minimal (SPM)</h4>
          <table className="w-full border-collapse border border-gray-400 mb-10">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-gray-400 px-4 py-2">
                  <a className="" href="#">
                    SK Kadinkes tentang SPM Pengembangan
                  </a>
                </td>
                <td className="border border-gray-400 px-4 py-2">
                  <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Lihat</button>
