...
const Lkjp = () => {
  return (
    <div
      className="lg:translate-x-0 translate-x-20 my-10 lg:h-[500px] lg:w-[850px] w-[480px]  border lg:rounded-3xl lg:m-10 bg-white dark:bg-gray-900 dark:text-white duration-200 h-[460px] overflow-y-auto  drop-shadow-[-5px_5px_8px_rgba(0,0,0,0.3)]"
      style={{ fontFamily: "Montserrat, sans-serif" }}
    >
      {" "}
      <div className="flex items-center justify-center w-max container">
        <div className="lg:w-[600px] w-[380px]">
          <h4 className="font-bold text-[19px] my-5 text-center">Laporan Kinerja Instansi Pemerintah (LKjIP)</h4>
