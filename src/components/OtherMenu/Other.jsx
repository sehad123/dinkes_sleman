...
const Other = () => {
  return (
    <>
      <div className=" lg:translate-x-0 translate-x-24 text-center mt-16 max-w-[600px] mx-auto">
      ...
      <div className="container lg:translate-x-0 translate-x-24 mx-auto px-4 py-20 ">
