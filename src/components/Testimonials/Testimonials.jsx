...
const Other = () => {
  return (
    <>
      <div className=" lg:translate-x-0 translate-x-24 text-center mt-20 lg:mb-2 mb-10 max-w-[600px] mx-auto">
        <h1 data-aos="fade-up" className="text-3xl font-bold">
          Informasi Lainnya
        </h1>
        {/* Dropdown untuk memilih bulan */}
      </div>
      <div className=" translate-x-24 container px-6 py-5 -mb-24 lg:-translate-x-24">
