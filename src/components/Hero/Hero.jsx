...
const Hero = ({ handleOrderPopup }) => {
  ...
  return (
    <div className="relative lg:translate-x-0 translate-x-16 container overflow-hidden w-[430px] lg:w-screen lg:h-[400px] h-[700px] bg-white lg:border-4 border-8 mt-10 dark:mt-0 rounded-xl flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200 drop-shadow-[-5px_5px_8px_rgba(0,0,0,0.3)] ">
      {/* background pattern */}
