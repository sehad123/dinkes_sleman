...
const SidebarInfo = ({ title, sidebarStyle }) => {
  ...
  return (
    <div className={`pb-[40px] dark:pb-[12px] bg-white dark:bg-gray-900 dark:text-white duration-200 sidebar-wrapper ${isSidebarOpen ? "" : "closed"} lg:border-r-2 border-b-2 lg:border-b-0 border-gray-300 `}>
